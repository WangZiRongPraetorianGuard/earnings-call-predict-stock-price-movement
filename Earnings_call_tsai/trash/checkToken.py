...
# 讀取CSV文件
df = pd.read_csv(r'C:\Users\user\earnings-call-predict-stock-price-movement\Earnings_call_tsai\Preprocessing\preprocessed_data_binary_label.csv')
...
training_args = TrainingArguments(
    output_dir='./results',
    num_train_epochs=3,
    per_device_train_batch_size=1,  # 調整batch size以適應大長度文本
